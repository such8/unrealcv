...
void UAnnotationCamSensor::InitTextureTarget(int _FilmWidth, int _FilmHeight)
{
	EPixelFormat PixelFormat = EPixelFormat::PF_B8G8R8A8;
	bool bUseLinearGamma = true;
	TextureTarget->InitCustomFormat(_FilmWidth, _FilmHeight, PixelFormat, bUseLinearGamma);
}
